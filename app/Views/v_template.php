...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>SIMasjid | Al - Istiqomah</title>
                                    ...
                                    <div class="slimscroll noti-scroll">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                            <div class="notify-icon">
                                                <img src="<?= base_url()?>assets\images\users\avatar-1.jpg" class="img-fluid rounded-circle" alt=""> </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Topbar light</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
